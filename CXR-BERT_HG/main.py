...
def train(args):
    ...
    trainer = CXRBERT_Trainer(args, cxrbert, train_dataloader=train_data_loader, test_dataloader=test_data_loader,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_image_embeds", type=int, default=5)  # TODO: 224x224, output fiber 9...

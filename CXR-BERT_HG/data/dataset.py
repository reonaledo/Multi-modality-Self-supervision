...
class MLMDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        txt_labels_p_i = [-1] * (self.max_seq_len - len(input_ids) + self.args.num_image_embeds)

        txt_labels = txt_labels_t + txt_labels_p_i

        # TODO: Attention_mask(to distinguish padded or not), also applied to special tokens
        ...
        # TODO: Image input format, 1) whole and process at next step or 2) sample fiber at first

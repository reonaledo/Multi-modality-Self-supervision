...
def get_data_loaders(args):
    ...
    """
    ["'Lung Opacity'", "'Cardiomegaly'", "'Edema'", "'Atelectasis'", "'Consolidation'", 
    "'Pleural Effusion'", "'Support Devices'", "'No Finding'", "'Pneumonia'", "'Others'", 
    "'Pleural Other'", "'Pneumothorax'", "'Lung Lesion'", "'Enlarged Cardiomediastinum'", "'Fracture'"]
    """

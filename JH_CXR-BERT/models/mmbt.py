...
from pytorch_pretrained_bert.modeling import BertModel # here need to be changed to Clinical BERT or some other method

from models.image import ImageEncoder



"Using pre-trained BERT weights. the architecture takes contextual embeddings as input, where each contextual"
"embedding is computed as the sum of seprate D-dimensional segment, position and token embeddings."
"We learn weights (2048 X D) to map each of the N image embeddings to D-dimensional token input embeddings via an"
"affine transformation: f(img, n) where n is the n-th output of the image encoder's final pooling operation."


"1. Image BERT embedding, 2. "

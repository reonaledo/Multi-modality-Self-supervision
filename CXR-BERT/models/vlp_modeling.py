...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, vis_feats, input_ids, token_type_ids=None, position_ids=None, vis_input=True, len_vis_input=None):
...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, vis_feats, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True, len_vis_input=None):
...
class BertModelIncr(BertModel):
    ...
    def forward(self, vis_feats, input_ids, token_type_ids, position_ids, attention_mask,
        ...
        embedding_output = self.embeddings(
            vis_feats, input_ids, token_type_ids, position_ids,
...
class BertForSeq2SeqDecoder(PreTrainedBertModel):
    ...
    def __init__(self, config, mask_word_id=0, num_labels=2,
                 ...
                 ngram_size=3, min_len=0, enable_butd=False, len_vis_input=None):
    ...
    def forward(self, vis_feats, input_ids, token_type_ids, position_ids, attention_mask, task_idx=None, sample_mode='greedy'):
    ...
    def beam_search(self, vis_feats, input_ids, token_type_ids, position_ids, attention_mask, task_idx=None):
        ...
        while next_pos < output_length:
            ...
            print("curr_ids",curr_ids.size())
            print("mask_ids",mask_ids.size())
            input("stipo!")
            x_input_ids = torch.cat((curr_ids, mask_ids), dim=1)

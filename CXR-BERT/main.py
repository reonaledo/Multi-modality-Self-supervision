...
from models.cxrbert_origin import CXRBertEncoder_origin
...
def train(args):
    wandb.init(config=args, project="CXR-BERT", entity="mimic-cxr")
...
if __name__ == '__main__':
    ...
    if scenari == 1:
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_full_attn'
        parser.add_argument("--mode", type=str, default='bi', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=False, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
    ...
    # #scenari 2> 224x224, img 36, txt 128, redqr attention., you should 추가 helper에서 resize option.
        ...
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_red_sqr'
        parser.add_argument("--mode", type=str, default='bi', choices=['s2s','bi'])
    ...
    # #scenari 3> 224x224, img 36, txt 128, 2d s2s attention., you should 추가 helper에서 resize option.
        ...
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_s2s'
        parser.add_argument("--mode", type=str, default='s2s', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=False, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
        parser.add_argument("--seq_len", type=int, default=128, help="maximum sequence len")
        parser.add_argument("--from_scratch", type=str, default=False, help="The model will be trained from scratch!!: True or False")

    # #scenari 4> 224x224, img 36, txt 128, random attention., you should 추가 helper에서 resize option.
    elif scenari == 4:
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_random_50prob'
        parser.add_argument("--mode", type=str, default='bi', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=True, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
        parser.add_argument("--seq_len", type=int, default=128, help="maximum sequence len")
    ...
    #scenari 1> 224x224, img 36, txt 128, 2d full attention., you should 추가 helper에서 resize option.
    if scenari == 5:
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_full_attn_base'
        parser.add_argument("--mode", type=str, default='bi', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=False, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
        parser.add_argument("--seq_len", type=int, default=128, help="maximum sequence len")
        parser.add_argument("--from_scratch", type=str, default=True, help="The model will be trained from scratch!!: True or False")

    # #scenari 2> 224x224, img 36, txt 128, redqr attention., you should 추가 helper에서 resize option.
    elif scenari == 6:
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_red_sqr_base'
        parser.add_argument("--mode", type=str, default='bi', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=True, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
        parser.add_argument("--seq_len", type=int, default=128, help="maximum sequence len")
    ...
    # #scenari 3> 224x224, img 36, txt 128, 2d s2s attention., you should 추가 helper에서 resize option.
        ...
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_s2s_base'
        parser.add_argument("--mode", type=str, default='s2s', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=False, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
        parser.add_argument("--seq_len", type=int, default=128, help="maximum sequence len")
    ...
    # #scenari 4> 224x224, img 36, txt 128, random attention., you should 추가 helper에서 resize option.
        ...
        output_path = '/home/mimic-cxr/model/12.31_img36_txt128_random_50prob_base'
        parser.add_argument("--mode", type=str, default='bi', choices=['s2s','bi'])
        parser.add_argument("--masked_attnt_dropout", type=int, default=True, choices=[True, False])
        parser.add_argument("--num_image_embeds", type=int, default=36)  # TODO: 224x224, output fiber 49...
        parser.add_argument("--seq_len", type=int, default=128, help="maximum sequence len")
    ...
    parser.add_argument("--mask_prob", type=int, default=0.15, help="maximum sequence len")

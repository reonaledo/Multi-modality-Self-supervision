...
def get_args(parser):
    ...
    parser.add_argument("--batch_sz", type=int, default=56)
    ...
    output_path = "/home/hglee/cxr-bert/Classification/mmbt/output/" + str(now)
...
def train(args):
    ...
    for i_epoch in range(start_epoch, args.max_epochs):
        ...
        wandb.log({
            ...
            "class accuracy": classACC,  # AUC per class
        })
